...
$query = "SELECT e.*, u.full_name 
          ...
          AND (e.description LIKE '%layer%' OR e.description LIKE '%egg%' OR e.category = 'feeds')
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_expense'])) {
    ...
    header("Location: layer_expenses.php?month=" . $month);
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    document.getElementById('monthSelector').addEventListener('change', function() {
        window.location.href = 'layer_expenses.php?month=' + this.value;
    });
    
    function editExpense(expenseId) {
        // Fetch expense data and populate edit form
